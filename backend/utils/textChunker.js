/*
*Split texts into chunks for better AI processing
*@param {string} text - Full text to chunk
*@param {number} chunkSize - Target size per chunk (in words)
*@param {number} overlap - Number of words to overlap between chunks
*@returns {Array<{content: string, chunkInkdex: number, pageNumber: number}>}
*/
...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
    ...
    for(const paragraph of paragraphs){
        ...
        // if single paragraph eceed chunk size, split it by words
        if (paragraphWordCount > chunkSize) {
            ...
            // split large pargraphs into word-based chunks
            for(let i = 0; i<paragraphWords.length; i+= (chunkSize - overlap)){
                ...
                if(i+chunkIndex >= paragraphWords.length) break;
            }
            continue;
        }
        ...
        if (currentWordCount + paragraphWordCount > chunkSize && currentChunk.length > 0) {
            ...
            // craete overlap from previous chunk
    ...
    // fallback: if no chunk crated , split by words
    ...
    return scoredChunks
        ...
        .sort((a,b) => {
            ...
            if (b.matchWords !== a.matchWords) {
                return a.matchWords - a.matchWords;
            }
