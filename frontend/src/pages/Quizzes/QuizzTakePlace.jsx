  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      const formattedAnswers = Object.keys(selectedAnswers).map(questionId => {
        ...
        return { questionIndex, selectedAnswer: optionIndex.toString() };
      })
    ...
    <div className='max-w-4xl mx-auto'>
        ...
        {currentQuestionIndex === quiz.questions.length - 1 ? (
          ...
          >
            <span className='relative z-10 flex items-center justify-center gap-2'>
              {submitting ? (
                <>
                  <div className='w-4 h-4 border-white/30 border-2 border-t-white rounded-full animate-spin' />
                  Submitting...
                </>
              ) : (
                <>
      ...
      <div className='mt-4 flex items-center justify-center gap-2 flex-wrap'>
        {quiz.questions.map((_, index) => {
          const isAnsweredQuetsion = selectedAnswers.hasOwnProperty(quiz.questions[index]._id)
