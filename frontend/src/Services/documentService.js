...
const getDocuments = async () => {
    try {
        ...
        // const response = await axiosInstance.get(API_PATHS.DOCUMENTS.GET_DOCUMENTS, {documentId, ...options});
...
const getDocumentById = async (id) => {
    try {
        const response = await axiosInstance.get(API_PATHS.DOCUMENTS.GET_DOCUMENT_BY_ID(id)); //Remove history from payload
        return response.data;
    } catch (error) {
